...
export default function Sidebar_sample(){
    const [extend, setExtend] = useState(true);
    return(
        <>
          <aside className="h-screen absolute bg-green shadow-lg">
            ...
            <a href="#" className={`font-serif text-xl ${!extend ? 'overflow-hidden w-0' :'w-auto'}`} onClick={()=>{setOption(5);}}>Transactions</a>
                </li>
            </ul>
